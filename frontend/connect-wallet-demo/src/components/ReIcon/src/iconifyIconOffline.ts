...
import outlinecollections from "@iconify-icons/ic/outline-collections";
import outlineGamepad from "@iconify-icons/ic/outline-gamepad";
import shoppingCart from "@iconify-icons/uil/shopping-cart";
addIcon("check", Check);
addIcon("menu", Menu);
...
addIcon("more", More);
addIcon("outline-collections", outlinecollections);
addIcon("outline-gamepad", outlineGamepad);
addIcon("shopping-cart", shoppingCart);
...
// Iconify Icon được sử dụng ngoại tuyến trong Vue (cho môi trường mạng nội bộ) https://docs.iconify.design/icon-components/vue/offline.html
