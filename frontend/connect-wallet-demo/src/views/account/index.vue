...
const onLogin = async (formEl: FormInstance | undefined) => {
  ...
  if (!formEl) return;
  /* userStoreHook.SET_CACCOUNT(
    "adminadminadminadminadminadmin32",
      ...
      userLogin(data)
        .then(result => {
          ...
          if (result.data.accessToken) {
            userStoreHook.cAccount.accessToken = result.data.accessToken;
            if (result.data.user) {
            ...
            userStoreHook.SET_CURRENTPAGE(2);
            ElMessage({
...
function onHandle() {
  userStoreHook.SET_CURRENTPAGE(1);
}
              ...
              <div class="ask">
                <Motion :delay="300">
                  ...
                  <p>
                    ...
                    <el-link @click="onHandle">Register</el-link>
                  </p>
                </Motion>
              </div>
            </el-form>
