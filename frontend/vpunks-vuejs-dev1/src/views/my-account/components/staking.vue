<template>
  <div v-loading="stakingLoading" class="staking-container">
    <!-- Your Staking -->
    ...
    <p style="font-size:14px;color:#c58001;">Note: the stakes you get from others will not show here, it will show on each NFT if it exists, go to <el-link href="#/my-account" type="primary">Your NFTs</el-link></p>
