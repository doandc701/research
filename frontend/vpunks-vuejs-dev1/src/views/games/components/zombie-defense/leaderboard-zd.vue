<template>
  <div style="text-align: right;">
    <el-button class="my-button01-medium" type="primary" :loading="leaderboardBtnLoading" @click="handleLeaderboard"><i class="el-icon-s-data" /><span class="hide-text"> Leaderboard</span></el-button>
    <!-- Dialog Leaderboard -->
